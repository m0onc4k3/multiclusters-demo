...
INSTALLED_APPS = [
    ...
    #'django.contrib.auth', # Keep for now KeyCloak
    'django.contrib.contenttypes',
    'django.contrib.sessions', # keep for session-based features
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware', # attempts to save a session in django.contrib.sessions.backends.db.SessionStore
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    #'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    #'oauthlib.integrations.django.OAuthLibMiddleware',  # For OAuth KeyCloak
]
...
LOGGING = {
    ...
    'loggers': {
        '': {
            'handlers': ['console'],
            'level': 'DEBUG', # DEBUG: detailed login | INFO
        },
    },
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': f'redis://{os.environ.get("REDIS_HOST", "my-redis")}:6379/1',  # Use DB 1 to avoid Celery conflict (Celery uses 0)
    }
}
